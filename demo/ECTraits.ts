...
async function main() {
    ...
    const getTraitsCall = ZoomLibraryInstance.addCall(
        ...
        //
        // !!! return types are important, as the decoder needs to know how to decode.. please specify a tuple
        //
    ...
    for(let i = 0; i < tokens.length; i++) {
        console.log("id", tokens[i].id, tokens[i].uri);
        console.log(tokens[i].traits);
        console.log("");
    }
